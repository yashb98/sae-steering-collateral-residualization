...
BASE = Path('/home/yashb98/Downloads/sae-steering-collateral-residualization')
...
def prepare(setting, model, sae, cfg, data, out):
    ...
    save(out/'manifest.json', {'setting':setting, 'config':cfg, 'created_utc':time.strftime('%Y-%m-%dT%H:%M:%SZ',time.gmtime()),
